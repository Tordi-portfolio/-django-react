...
SERVICES = [
    ...
    },
    {
        ...
        'desc': (
            ...
            "load. We size and install upgraded breaker panels and service entrances so "
            "your circuits aren't working overtime — or tripping when you least want them to."
        ),
    },
    {
        'trade': 'electrical',
...
REVIEWS = [
    ...
    },
    {
        ...
        'body': (
            "We needed a panel upgrade for our shop without shutting down for more than a "
            "day. Robert's crew planned it out ahead of time and it went exactly to "
...
FAQS = [
    ...
    },
    {
        ...
        'a': (
            "Yes. We're fully licensed, insured, and bonded for both plumbing and "
            "electrical work, for residential and commercial properties alike. Proof of "
    ...
    },
    {
        ...
        'a': (
            "For active leaks, no power, or anything that can't wait, we prioritize "
            "same-day dispatch and are reachable 24/7 by phone. For non-urgent work we'll "
            "schedule a time that fits your calendar."
        ),
    },
    {
    ...
    },
    {
        ...
        'a': (
            ...
            "(if you enable it) get an alert the moment we reply, even when the app isn't open."
        ),
    },
]
...
def business_info(request):
    """Everything the React home/about pages need in one call: business
    details, service list, the 'how it works' steps, sample reviews, and
    FAQs. Public — no auth required."""
    return Response({
